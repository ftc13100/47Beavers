    ...
    <header className="bg-blue-800 w-full sticky top-0 justify-between">
      <div className="mx-24 h-12 flex items-center justify-between py-16">
        <a className="my-8 text-white" href="/">
          ...
          <nav className="text-white flex flex-wrap items-start py-4 space-x-8">
            ...
            <div className="group flex flex-none flex-col items-center flex-wrap">
              ...
              <div className="flex">
                <div className="hidden group-hover:flex absolute right-8 flex-col space-y-2 items-center first:pt-4 last:pb-2 px-4 bg-blue-800">
                  <a href="/camps/robotics" className="hover:underline">Robotics Design Camps</a>
                  <a href="/camps/mathematics" className="hover:underline">Mathematics Camps</a>
                  <a href="/camps/physics" className="hover:underline">Programming Camps</a>
                  <a href="/camps/programming" className="hover:underline">Physics Camps</a>
                </div>
              </div>
            </div>
          </nav>
